...
public class CompanyBusActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_companybus);
    ...
    public void onClick() {
       ...
       /* if(TextUtils.isEmpty(beizhu)){
            ToastUtils.showShort(this,"请添加备注" );
            return;
        }*/
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(boolean isFromCache, String jsonstring, Request request, @Nullable Response response) {
                        ...
                        if (jsonstring == null || jsonstring.equals("")) {
                            ToastUtils.showLong(CompanyBusActivity.this, "提交失败");
                            return;
                        }
                        ...
                        try {
                            ...
                            if (mJsonObject.getString("urlflag").equals("success")) {
                                ToastUtils.showLong(CompanyBusActivity.this, "提交成功");
                                CompanyBusActivity.this.finish();
                            }
                    ...
                    public void onError(boolean isFromCache, Call call, @Nullable Response response, @Nullable Exception e) {
                        ...
                        ToastUtils.showLong(CompanyBusActivity.this, "连接失败");
                    }
                });
    }
}
