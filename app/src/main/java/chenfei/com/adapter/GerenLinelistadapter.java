 ...
 * @return
 */
public class GerenLinelistadapter extends BaseQuickAdapter<GetLinesInfo.DataBean> {

	private Context mcontext;
	public GerenLinelistadapter(Context context, int layoutResId, List<GetLinesInfo.DataBean> data) {
		super(layoutResId, data);
		this.mcontext=context;

	}

	public GerenLinelistadapter(Context context, int layoutResId, List<GetLinesInfo.DataBean> data, int dataSize) {
